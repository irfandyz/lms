    ...
    <div class="row mt-5">
        ...
        <div class="col-sm-4">
            ...
            <form action="{{ asset('sign-up') }}" method="post">
                ...
                @endif
                <input type="text" value="{{old('email')}}" name="email" id="email" class="input-form" placeholder="Email">
                @if($errors->has('email'))
            ...
            <p class="text-center mt-2" style="color: #5e5e5e;font-size:18px">
                Sudah Punya Akun? <a href="{{ asset('sign-in') }}" class="text-primary text-decoration-none">Masuk</a> Sekarang
            </p>
        </div>
    </div>
