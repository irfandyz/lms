				...
				<div class="sidebar-content">
					...
					<ul class="nav nav-primary">
						<li class="nav-item active">
							<a href="{{ asset('administrator/dashboard') }}" class="collapsed" >
						...
						<li class="nav-item">
							...
							<div class="collapse" id="base">
								<ul class="nav nav-collapse">
									<li>
										<a href="{{ asset('administrator/lecture') }}">
											<span class="sub-item">Your Lecture</span>
										</a>
									</li>
									<li>
										<a href="{{ asset('administrator/lecture/create') }}">
